    ...
    return (
        <>
            <div className="container">
                ...
                <div className="row p-5 border-top m-5">
                    <div className="col-6 p-5 mt-5 text-muted lh-lg">
                    ...
                    <div className="col-6 p-5 mt-5 text-muted lh-lg">
                        ...
                        <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="/z-connect" style={{textDecoration:"none"}}>blog</a> or see what the media is <a href="/media" style={{textDecoration:"none"}}>saying about us</a></p>
                    </div>
                </div>
            </div>
        </>
